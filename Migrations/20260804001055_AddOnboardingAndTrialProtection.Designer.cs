...
namespace EntregasApi.Migrations
{
    ...
    [Migration("20260804001055_AddOnboardingAndTrialProtection")]
    partial class AddOnboardingAndTrialProtection
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntregasApi.Models.Account", b =>
                {
                    ...
                    b.Property<DateTime?>("BuyerOnboardingCompletedAtUtc")
                    ...
                    b.Property<DateTime?>("SellerOnboardingCompletedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("SellerTrialDeviceHash")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<DateTime?>("SellerTrialEvaluatedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("SellerTrialGrantedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("SellerTrialRestrictionReason")
                        .HasMaxLength(40)
                    ...
                    b.HasIndex("SellerTrialDeviceHash")
                        .IsUnique()
            ...
            modelBuilder.Entity("EntregasApi.Models.InventoryBox", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EntregasApi.Models.InventoryCountEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("InventoryCountSessionId", "InventoryItemId")
                        .IsUnique();

                    b.ToTable("InventoryCountEntries");
                });

            modelBuilder.Entity("EntregasApi.Models.InventoryCountSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("InventoryBoxId", "CountedAt");

                    b.ToTable("InventoryCountSessions");
                });

            modelBuilder.Entity("EntregasApi.Models.InventoryItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("BusinessId", "LabelCode")
                        .IsUnique();
            ...
            modelBuilder.Entity("EntregasApi.Models.InventoryMovement", b =>
                {
                    ...
                    b.HasIndex("InventoryBoxId", "OccurredAt");
            ...
            modelBuilder.Entity("EntregasApi.Models.LabelPrintJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EntregasApi.Models.LabelPrintJobItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PackageQrCodeValue")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.HasIndex("BusinessId", "OrderPackageId");

                    b.HasIndex("LabelPrintJobId", "Sequence")
                        .IsUnique();
            ...
            modelBuilder.Entity("EntregasApi.Models.LabelTemplate", b =>
                {
                    ...
                    b.HasIndex("BusinessId", "Kind", "MediaSize", "IsDefault")
                        .IsUnique()
            ...
            modelBuilder.Entity("EntregasApi.Models.LinkEvent", b =>
                {
                    ...
                    b.Property<string>("OrderAccessToken")
                        .IsRequired()
                        .HasMaxLength(80)
                        .HasColumnType("character varying(80)");
            ...
            modelBuilder.Entity("EntregasApi.Models.LiveAnnouncement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime?>("CurrentAnnouncedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int?>("CurrentProductId")
                        .HasColumnType("integer");

                    b.Property<string>("CurrentProductName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
            ...
            modelBuilder.Entity("EntregasApi.Models.Order", b =>
                {
                    ...
                    b.Property<int?>("MergedIntoOrderId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EntregasApi.Models.OrderItem", b =>
                {
                    ...
                    b.Property<int?>("OriginalClientId")
                        .HasColumnType("integer");

                    b.Property<string>("OriginalClientName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
            ...
            modelBuilder.Entity("EntregasApi.Models.OrderMergeAudit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("ItemsMoved")
                        .HasColumnType("integer");

                    b.Property<DateTime>("MergedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<decimal>("PaymentsMoved")
                        .HasColumnType("decimal(10,2)");
            ...
            modelBuilder.Entity("EntregasApi.Models.PayoutAccount", b =>
                {
                    ...
                    b.HasIndex("BusinessId", "IsActive", "IsDefault")
            ...
            modelBuilder.Entity("EntregasApi.Models.StorePost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EntregasApi.Models.InventoryCountEntry", b =>
                {
                    ...
                    b.HasOne("EntregasApi.Models.InventoryCountSession", "InventoryCountSession")
                        .WithMany("Entries")
            ...
            modelBuilder.Entity("EntregasApi.Models.InventoryCountSession", b =>
                {
                    ...
                    b.HasOne("EntregasApi.Models.InventoryBox", "InventoryBox")
                        .WithMany("CountSessions")
                        .HasForeignKey("InventoryBoxId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EntregasApi.Models.InventoryMovement", b =>
                {
                    ...
                    b.HasOne("EntregasApi.Models.InventoryItem", "InventoryItem")
                        .WithMany("Movements")
            ...
            modelBuilder.Entity("EntregasApi.Models.LabelPrintJobItem", b =>
                {
                    ...
                    b.HasOne("EntregasApi.Models.LabelPrintJob", "LabelPrintJob")
                        .WithMany("Items")
                        .HasForeignKey("LabelPrintJobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EntregasApi.Models.OrderPackage", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EntregasApi.Models.Order", b =>
                {
                    ...
                    b.HasOne("EntregasApi.Models.Order", "MergedIntoOrder")
                        .WithMany()
                        .HasForeignKey("MergedIntoOrderId")
                        .OnDelete(DeleteBehavior.SetNull);
