        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultShippingCost = table.Column<decimal>(type: "numeric", nullable: false),
                    LinkExpirationHours = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    DriverToken = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostponedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    PostponedNote = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Investments_Suppliers_SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Deliveries_DeliveryRoutes_DeliveryRouteId",
                        column: x => x.DeliveryRouteId,
                        principalTable: "DeliveryRoutes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "AppSettings",
                columns: new[] { "Id", "DefaultShippingCost", "LinkExpirationHours" },
                values: new object[] { 1, 60m, 72 });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryRoutes_DriverToken",
                table: "DeliveryRoutes",
                column: "DriverToken",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Investments_Date",
                table: "Investments",
                column: "Date");

            migrationBuilder.CreateIndex(
                name: "IX_Investments_SupplierId",
                table: "Investments",
                column: "SupplierId");
